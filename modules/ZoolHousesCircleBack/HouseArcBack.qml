...
import ZoolandBodies.ZoolArcBack 1.0
...
//    }
    ...
    ZoolArcBack{
        id: zsa
        width: sweg.width*2-sweg.pz*2-vars.fs
        height: width
        w: sweg.width-signCircle.width*0.5//sweg.pz
...
//            }
            ...
            ZoolText{
                ...
                color: apps.fontColor
                anchors.centerIn: parent
                rotation: 0-r.rotation-90-15
                //rotation: 0-housesCircleBack.rotation+r.rotation//-parent.rotation
            }
