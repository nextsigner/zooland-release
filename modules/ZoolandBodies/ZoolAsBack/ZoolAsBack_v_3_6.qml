...
Item{
    ...
    width: sweg.width*2-(sweg.pz*0.5*objData.p)-sweg.pz*2-vars.fs*2//signCircle.width+((sweg.pz*0.5*objData.p))+vars.fs*2+(sweg.pz*2+vars.fs*2)
    height: 1
    ...
    property bool selected: numAstro === sweg.currentPlanetIndexBack
